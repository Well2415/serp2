...
const solutions = [
    {
        ...
        features: ["Emissão de Notas em segundos", "Controle de Estoque Multilocal", "Integração B ancaria", "Relatórios de DRE e Lucratividade"],
